...
const navItems = [
  ...
  { icon: ListOrdered, label: 'Queue', href: '/doctor/queue' },
  { icon: Pill, label: 'Prescriptions', href: '/doctor/prescriptions' },
  { icon: FileText, label: 'Medical Records', href: '/doctor/medical-records' },
  { icon: Activity, label: 'Medical Tests', href: '/doctor/medical-tests' },
      ...
      <div className="flex h-18 items-center px-6">
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex flex-col items-start leading-[1.1]">
            ...
            <span className="text-[12px] font-bold text-secondary uppercase tracking-wider">Doctor</span>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      ...
      <header className="md:hidden flex h-16 items-center justify-between border-b border-border-light bg-surface px-4 sticky top-0 z-30">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-primary">Doctor Portal</span>
        </div>
