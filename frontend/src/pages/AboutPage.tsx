    ...
    <div className="pt-24 pb-20 min-h-[80vh] bg-gray-50 flex items-center justify-center">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-gray-500 mb-10 max-w-xl mx-auto">
          We are working hard to bring you the full story of Noor Healthcare, our vision, mission, and the incredible team behind our success. Stay tuned!
        </p>
